...
export const mars: PlanetContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        "The Martian atmosphere is about 95% carbon dioxide, 2.6% nitrogen and 1.9% argon, with traces of oxygen, carbon monoxide and water vapour. Its surface pressure averages about 6 millibars, less than 1% of Earth's and roughly what you would find 35 km up in our own atmosphere. At that pressure, liquid water boils away or freezes almost immediately; it can exist only briefly as brine in the very lowest, warmest places.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "A Martian day, called a sol, lasts 24 hours 39 minutes, so a human's body clock would adjust easily; rover teams on Earth have famously lived on 'Mars time' for months. A year is 687 Earth days, and because Mars and Earth line up only every 26 months, a round trip would most likely mean a stay of around a year and a half waiting for the planets to line up again. Fine, sharp, toxic dust that gets into everything would be the everyday enemy of anyone living there.",
      ],
  ...
  timeline: [
    ...
    { year: "1997", title: "Sojourner rover", detail: "Mars Pathfinder lands with the first rover, the 10-kg Sojourner, which explores for 83 sols." },
