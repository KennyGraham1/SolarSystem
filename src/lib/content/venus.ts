...
export const venus: PlanetContent = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "For a long time nobody knew whether Venus's volcanoes were still alive. In 2023 researchers re-examining Magellan radar images from 1990 and 1991 found a volcanic vent near Maat Mons that had changed shape and grown in eight months, the first direct evidence of a recent eruption. Combined with fluctuating sulphur dioxide in the atmosphere and hot spots seen by ESA's Venus Express, it now seems clear that Venus is volcanically active today.",
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "NASA's Magellan orbiter mapped 98% of the surface with radar between 1990 and 1994, providing the maps still used today. ESA's Venus Express (2006 to 2014) studied the atmosphere and found evidence of recent volcanism, while Japan's Akatsuki orbiter studied the super-rotating winds from 2015 until contact was lost in 2024. In between, several spacecraft bound for other targets, including Parker Solar Probe, BepiColombo and Solar Orbiter, have used Venus for gravity assists and gathered data along the way.",
        "A new wave is planned. NASA selected two missions in 2021: DAVINCI, which will drop a probe through the atmosphere to sample its chemistry and photograph the surface on the way down, now targeting launch in December 2030 with arrival in early 2033, and VERITAS, a radar-mapping orbiter aiming for launch around 2031. Both have faced budget pressure and delays. ESA's EnVision orbiter is scheduled to launch in November 2031 to study the planet from core to upper atmosphere, and a small privately funded probe, Rocket Lab's Venus Life Finder, plans to search the clouds for organic molecules once its Neutron rocket is ready.",
      ],
    },
    {
  ...
  layers: [
    {
      ...
      color: "#e8d9b0",
      radiusFraction: 0.53,
      detail: "Iron-nickel, ~3,200 km radius; may be partly molten, roughly 5,000 °C",
    },
    {
      name: "Mantle",
  ...
  timeline: [
    ...
    { year: "2030–31", title: "The next wave", detail: "NASA's DAVINCI probe (planned launch December 2030), VERITAS (around 2031) and ESA's EnVision (November 2031) are scheduled to head for Venus." },
  ],
  comparisons: [
