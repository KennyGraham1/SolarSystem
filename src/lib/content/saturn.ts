...
export const saturn: PlanetContent = {
  id: "saturn",
  ...
  sections: [
    ...
    {
      title: "Moons: Titan, Enceladus and hundreds more",
      paragraphs: [
        "Saturn's confirmed moon count jumped to 274 in 2025 when 128 small, irregular moons were announced at once, and further batches in 2026 took it to 293; almost all of these are captured fragments a few kilometres across on distant, tilted orbits. The seven major moons, in order from Saturn, are Mimas, Enceladus, Tethys, Dione, Rhea, Titan and Iapetus, and each has its own character: Mimas with its enormous Herschel crater, Iapetus with one hemisphere black and the other white, Rhea and Dione with wispy ice cliffs.",
        "Titan is the second-largest moon in the solar system and the only one with a substantial atmosphere, a nitrogen-methane blanket 1.5 times as thick as Earth's air that hides the surface beneath orange smog. Beneath it, Cassini's radar and ESA's Huygens probe, which landed in January 2005, found a startlingly Earth-like landscape: rivers, dunes, seas and lakes filled not with water but with liquid methane and ethane at −180 °C, and probably an ocean of liquid water far below the icy crust.",
        "Enceladus is only 500 km across, yet in 2005 Cassini discovered geysers of water vapour and ice erupting from four long fractures at its south pole, the 'tiger stripes'. Flying through the plumes, Cassini tasted salt, silica grains, organic molecules and hydrogen, chemistry that on Earth feeds microbes around deep-sea vents. Enceladus has a global ocean beneath its ice and is now one of the top targets in the search for life. In 2024, subtle wobbles in Mimas's orbit revealed that even that small, ancient-looking moon has a young ocean inside it.",
      ],
      highlight: "Enceladus sprays its ocean into space, and Cassini found salt, organic molecules and hydrogen in the spray.",
    },
    {
    ...
    },
    {
      ...
      highlight: "On Titan, low gravity and thick air mean a person could fly by flapping strap-on wings.",
    },
  ],
  layers: [
    {
    ...
    },
    {
      ...
      description: "Liquid hydrogen and helium in which helium droplets 'rain' downward, releasing heat.",
      color: "#c9ad78",
      radiusFraction: 0.99,
      detail: "Liquid then gaseous hydrogen and helium",
    },
    {
      name: "Atmosphere",
      description: "Ammonia haze over layered clouds, screaming jet streams and the north-polar hexagon.",
      color: "#e3cf9a",
      radiusFraction: 1,
      detail: "Hydrogen and helium, about −140 °C at the cloud tops",
    },
  ],
  timeline: [
    ...
    { year: "1980–81", title: "Voyager 1 and 2", detail: "The Voyagers reveal the rings' intricate structure, the polar hexagon, shepherd moons and Titan's dense atmosphere." },
    { year: "2004", title: "Cassini enters orbit", detail: "On 1 July 2004 Cassini-Huygens becomes the first spacecraft to orbit Saturn, beginning a 13-year survey." },
    { year: "2005", title: "Huygens lands on Titan", detail: "ESA's probe parachutes onto Titan on 14 January 2005, the most distant landing ever, and images a landscape of rounded ice pebbles." },
    { year: "2005", title: "Enceladus plumes discovered", detail: "Cassini detects jets of water vapour and ice erupting from Enceladus's south pole." },
    { year: "2017", title: "Cassini's Grand Finale", detail: "After 22 dives between the rings and the planet, Cassini burns up in Saturn's atmosphere on 15 September 2017." },
    { year: "2025–26", title: "Moon count soars", detail: "128 newly confirmed moons bring Saturn's total to 274 in 2025, and 2026 announcements lift it to 293; in March 2025 the rings turn edge-on to Earth and seem to disappear." },
    { year: "2028", title: "Dragonfly launch (planned)", detail: "NASA's rotorcraft lander is scheduled to launch in July 2028 and reach Titan in 2034." },
  ],
  comparisons: [
    { label: "Diameter", value: 116464, earth: 12742, unit: "km" },
    { label: "Mass", value: 95.2, earth: 1, unit: "× Earth" },
    { label: "Surface gravity (cloud tops)", value: 10.44, earth: 9.81, unit: "m/s²" },
    { label: "Rotation period", value: 10.66, earth: 23.93, unit: "hours" },
    { label: "Year length", value: 10759, earth: 365.25, unit: "Earth days" },
    { label: "Mean distance from Sun", value: 1427, earth: 149.6, unit: "million km" },
    { label: "Mean temperature (cloud tops)", value: -140, earth: 15, unit: "°C" },
    { label: "Escape velocity", value: 35.5, earth: 11.19, unit: "km/s" },
  ],
  moons: [
    {
      name: "Titan",
      radiusKm: 2574.7,
      description: "Bigger than Mercury, with a thick nitrogen-methane atmosphere, rivers and seas of liquid methane, and a buried water ocean. Dragonfly will fly across it in the 2030s.",
    },
    {
      name: "Rhea",
      radiusKm: 763.8,
      description: "Saturn's second-largest moon, a heavily cratered ball of ice and rock with bright wispy fractures on its trailing side.",
    },
    {
      name: "Iapetus",
      radiusKm: 734.5,
      description: "A two-toned moon, one hemisphere coal-black and the other bright white, with a strange ridge of mountains running round its equator.",
    },
    {
      name: "Dione",
      radiusKm: 561.4,
      description: "An icy moon with towering cliffs of ice, possibly hiding a subsurface ocean.",
    },
    {
      name: "Enceladus",
      radiusKm: 252.1,
      description: "A small, brilliantly white moon that jets salty water from a global ocean through fractures at its south pole, feeding Saturn's E ring.",
    },
    {
      name: "Mimas",
      radiusKm: 198.2,
      description: "Dominated by the 130-km Herschel crater, which gives it a 'Death Star' look. Its orbital wobble revealed a young hidden ocean in 2024.",
    },
  ],
  quiz: [
    {
      prompt: "What are Saturn's rings mostly made of?",
      options: ["Rock and metal", "Water ice", "Frozen methane", "Gas"],
      answer: "Water ice",
      explanation: "The rings are trillions of chunks of nearly pure water ice, from dust grains to house-sized boulders, each following its own orbit around Saturn.",
    },
    {
      prompt: "Which statement about Saturn's density is true?",
      options: [
        "It is the densest planet",
        "It is less dense than water",
        "It is about the same density as Earth",
        "It is denser than Jupiter",
      ],
      answer: "It is less dense than water",
      explanation: "Saturn's mean density is about 0.69 g/cm³, so it would float in a large enough bath. It is the only planet less dense than water.",
    },
    {
      prompt: "What did the Huygens probe do in January 2005?",
      options: ["Orbited Saturn", "Flew through Enceladus's plumes", "Landed on Titan", "Crashed into the rings"],
      answer: "Landed on Titan",
      explanation: "ESA's Huygens probe, carried by Cassini, parachuted through Titan's atmosphere and landed on its surface, the most distant landing ever achieved.",
    },
    {
      prompt: "What did Cassini discover at the south pole of Enceladus?",
      options: ["A giant volcano of lava", "Jets of water vapour and ice from a hidden ocean", "A hexagonal storm", "A ring of moonlets"],
      answer: "Jets of water vapour and ice from a hidden ocean",
      explanation: "Geysers erupting from the 'tiger stripe' fractures showed that Enceladus has a subsurface ocean, and the plumes contain salt, organics and hydrogen.",
    },
    {
      prompt: "What shape is the jet stream at Saturn's north pole?",
      options: ["A circle", "A spiral", "A hexagon", "A square"],
      answer: "A hexagon",
      explanation: "Saturn's north-polar jet stream forms a stable six-sided pattern about 29,000 km across, a standing wave first seen by Voyager and studied in detail by Cassini.",
    },
  ],
  glossary: [
    { term: "Ring system", definition: "A flat disc of countless particles orbiting a planet. All four giant planets have one, but Saturn's is by far the brightest and broadest." },
    { term: "Cassini Division", definition: "The 4,800-km gap between Saturn's A and B rings, cleared by the gravitational pull of the moon Mimas." },
    { term: "Shepherd moon", definition: "A small moon whose gravity confines a ring's edge or keeps a narrow ring, such as the F ring, from spreading." },
    { term: "Helium rain", definition: "Droplets of helium separating from hydrogen and sinking through Saturn's interior, releasing the heat that makes the planet glow warmer than expected." },
    { term: "Hexagon", definition: "The six-sided jet stream circling Saturn's north pole, about 29,000 km across." },
    { term: "Cryovolcanism", definition: "Eruptions of water, ammonia or methane instead of molten rock, as seen in the plumes of Enceladus." },
    { term: "Grand Finale", definition: "Cassini's last 22 orbits in 2017, diving between the rings and the planet before burning up in Saturn's atmosphere." },
    { term: "Rotorcraft", definition: "A flying vehicle lifted by rotors. NASA's Dragonfly will use eight rotors to hop across Titan's surface." },
  ],
  sources: [
    { title: "NASA Saturn Fact Sheet", url: "https://nssdc.gsfc.nasa.gov/planetary/factsheet/saturnfact.html" },
    { title: "NASA Science: Saturn", url: "https://science.nasa.gov/saturn/" },
    { title: "NASA Science: Cassini mission", url: "https://science.nasa.gov/mission/cassini/" },
    { title: "NASA Science: Dragonfly", url: "https://science.nasa.gov/mission/dragonfly/" },
    { title: "ESA: Huygens probe", url: "https://www.esa.int/Science_Exploration/Space_Science/Cassini-Huygens" },
    { title: "NASA Science: Saturn Moons", url: "https://science.nasa.gov/saturn/moons/" },
  ],
};
