...
export const neptune: PlanetContent = {
  id: "neptune",
  tagline: "The planet found with a pen: a deep-blue ice giant with the fastest winds in the solar system, at the edge of the planetary system.",
  intro: [
  ...
  sections: [
    {
      ...
      paragraphs: [
        ...
        "The mantle is where the interesting chemistry happens. At depths of a few thousand kilometres, water becomes an ionic or superionic fluid that conducts electricity, and its swirling motion generates Neptune's magnetic field. Like Uranus's, that field is bizarre: tilted 47° from the rotation axis and offset from the centre by about half the planet's radius, evidence that it is produced in a relatively shallow layer. Experiments compressing methane suggest carbon may separate out as diamonds that sink through the mantle.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Bright, wispy clouds of methane ice ride high in the atmosphere and cast shadows on the deeper cloud deck. Below them lie clouds of hydrogen sulphide and ammonia, and deeper still, water clouds. At the 1-bar level the temperature is about −201 °C, almost the same as at Uranus despite the far greater distance from the Sun, thanks to the internal heat. Neptune's high-altitude cloud cover changes with the solar cycle: between 2019 and 2020 the clouds all but vanished, apparently because a lull in solar ultraviolet light reduced the haze on which they form.",
