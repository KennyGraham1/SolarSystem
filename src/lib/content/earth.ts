...
export const earth: PlanetContent = {
  ...
  sections: [
    ...
    },
    {
      title: "Atmosphere",
      paragraphs: [
        "Earth's air is 78% nitrogen, 21% oxygen, about 1% argon, and small but vital traces of water vapour, carbon dioxide (currently about 0.043%, or nearly 430 parts per million, and rising), methane and ozone. The oxygen is a biological signature: it is so chemically reactive that it would vanish from the air within a few million years if photosynthesis stopped replacing it. Any alien astronomer detecting oxygen in our spectrum would have good reason to suspect life.",
        ...
        "Greenhouse gases keep Earth habitable. Without water vapour and carbon dioxide trapping heat, the average temperature would be about −18 °C instead of 15 °C. But the balance is delicate. Burning fossil fuels has raised CO2 levels by about 50% since the industrial revolution, and the planet has warmed by roughly 1.3 to 1.4 °C so far, with 2024 the hottest year on record and 2023 to 2025 the first three-year stretch to average more than 1.5 °C above pre-industrial levels. Venus shows where a runaway greenhouse leads; Earth's climate is the subject of the most intense scientific monitoring of any planet.",
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The Moon's gravity raises the tides, which are gradually slowing Earth's spin (days were about 23.5 hours long when the last dinosaurs lived, and only 22 hours long 400 million years ago) and pushing the Moon away by 3.8 cm a year, a rate measured by bouncing lasers off reflectors left by Apollo astronauts. The Moon also keeps Earth's axial tilt stable at about 23.4°; without it, the tilt might wander chaotically and the climate with it.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Some of the most important measurements are the subtle ones. The GRACE satellites weigh groundwater and melting ice by sensing tiny changes in gravity. Radar altimeters have tracked sea level rising about 10 to 11 cm since 1993, at a rate that has more than doubled over that period. NASA's PACE satellite, launched in 2024, watches ocean plankton and aerosols, and the NISAR radar satellite, launched by NASA and India's ISRO in July 2025, maps changes in the ground to within a centimetre.",
        "Humans have lived in orbit continuously since November 2000 aboard the International Space Station, and China's Tiangong station has been permanently crewed since 2022. Around 780 people have flown to space so far. The ISS is due to be retired around 2030, with commercial stations intended to replace it.",
      ],
    },
    {
